<?php
  ...
  require_once 'cms/conexao.php';
    ...
    //Codigo para setar os valores do ambiente Retro

    $sql = "SELECT * FROM tbl_conteudo_ambiente WHERE idAmbiente = 3 and status = 1";//Retro
...
<html>
<head>
    <title>Padoka Hill Valley - Espaço Retrô</title>
            ...
            <div id="caixa-ambiente-leitura">
                    ...
                    <div id="slide-fotos">
                        <div id="conteudo-slide">
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto01);?>"  class="fotos-slides" title="Ambiente Retro" alt="Ambiente Retro">
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto02);?>" class="fotos-slides" title="Ambiente Retro" alt="Ambiente Retro">
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto03);?>" class="fotos-slides" title="Ambiente Retro" alt="Ambiente Retro">
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto04);?>" class="fotos-slides" title="Ambiente Retro" alt="Ambiente Retro">
                            </div>
                ...
                <div id="galeria-fotos"><!--Pequena galeria de fotos-->
                    <div id="fotos">
                           ...
                           <div class="foto-item">
                                <img src="cms/<?php echo($foto01);?>" class="foto-quadradinho" title="Ambiente retro" alt="Ambiente retro">
                            </div>
              
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto02);?>" class="foto-quadradinho" title="Ambiente retro" alt="Ambiente retro" >
                            </div>
                       
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto03);?>" class="foto-quadradinho" title="Ambiente retro" alt="Ambiente retro" >
                            </div>
                    
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto04);?>" class="foto-quadradinho" title="Ambiente retro" alt="Ambiente retro">
                            </div>
