<?php
  ...
  require_once 'cms/conexao.php';
    ...
    //Codigo para setar os valores do ambiente de leitura

    $sql = "SELECT * FROM tbl_conteudo_ambiente WHERE idAmbiente = 1 and status = 1";//Leitura
...
<html>
<head>
    <title>Padoka Hill Valley - Espaço Leitura</title>
            ...
            <div id="caixa-ambiente-leitura">
                    ...
                    <div id="slide-fotos">
                        <div id="conteudo-slide">
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto01);?>" class="fotos-slides" title="Slider Ambientes" alt="Slider Ambientes" >
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto02);?>" class="fotos-slides" title="Slider Ambientes" alt="Ambiente de leitura">
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto03);?>" class="fotos-slides" title="Slider Ambientes" alt="Slider Ambientes">
                            </div>
                            <div class="item-slide">
                                <img src="cms/<?php echo($foto04);?>" class="fotos-slides" title="Slider Ambientes" alt="Slider Ambientes">
                            </div>
                ...
                <div id="galeria-fotos"><!--Pequena galeria de fotos-->
                    <div id="fotos">
                            ...
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto01);?>" class="foto-quadradinho" title="Ambiente de Leitura" alt="Ambiente de Leitura">
                            </div>
              
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto02
                                                        );?>" class="foto-quadradinho" title="Ambiente de Leitura" alt="Ambiente de Leitura">
                            </div>
                       
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto03);?>" class="foto-quadradinho" title="Ambiente de Leitura" alt="Ambiente de Leitura">
                            </div>
                    
                            <div class="foto-item">
                                <img src="cms/<?php echo($foto04);?>" class="foto-quadradinho" alt="Ambiente de Leitura" title="Ambiente de Leitura">
                            </div>
