    ...
    if(isset($_GET['modo'])){
        ...
        if($modo == "excluir"){
            ...
            if($status == 1){
                ...
                $sql_zerar = "UPDATE tbl_conteudo_ambiente SET status = 0 where idAmbiente = 1";
            ...
            $sql = "select * from tbl_conteudo_ambiente where id=".$id." and idAmbiente = 1";//Leitura
...
<html>
<head>
    <title>CMS | Ambiente de Leitura</title>
    ...
    <div id="main">
        ...
        <div id="content">
                ...
                <div id="caixa-cadastro"><!--Caixa com inputs e fotos-->
                    ...
                    <form name="frmCadastro" id="frmCadastro" method="post" action="leitura.php">
                ...
                <div id="caixa-tabela"><!--Tabela dos dados da sessão-->
                    ...
                    <div id="tabela-dados">
                        <?php
                            $sql = "SELECT * FROM tbl_conteudo_ambiente WHERE idAmbiente = 1 order by id desc";//LEITURA
                            $res = mysqli_query($con, $sql);
                        ...
                        <div class="linha">
                                ...
                                <div class="campo">
                                 ...
                                 <div class="campo" style="text-align:center;">
                                     <a href="leitura.php?modo=excluir&id=<?php echo($rsDados['id']);?>" onclick="return confirm('Deseja Realmente excluir?')">
                                        <img src="imagens/gUsers/delete.png" class="foto-opcoes"> 
                                     </a>
                                    <a href="leitura.php?modo=consultar&id=<?php echo($rsDados['id']);?>">
                                        <img src="imagens/gUsers/edit.png" class="foto-opcoes"> 
                                     </a>
                                     <a href="leitura.php?modo=mudaStatus&id=<?php echo($rsDados['id']);?>&status=<?php echo($rsDados['status']);?>">
